...
public class SellOrder extends AppCompatActivity implements View.OnClickListener {

    private RelativeLayout sell_actionbar_back;
    private TextView sell_tv_actionbar_title;
    private Button sell_save;
    ...
    private TextView add_sell_order_detail;
...
//        id_clerk =
        ...
        sell_order_space.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 1) {
                    sell_order_addess_send.setEnabled(true);
                } else {
                    sell_order_addess_send.setEnabled(false);
...
//            dsaordbaseJson.setId_corr(performanceDatas.getMain().getId_corr());
    ...
    private void initView() {
        sell_actionbar_back = (RelativeLayout) findViewById(R.id.sell_actionbar_back);
        sell_actionbar_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        });
        sell_tv_actionbar_title = (TextView) findViewById(R.id.sell_tv_actionbar_title);
        sell_save = (Button) findViewById(R.id.sell_save);
...
//        sell_order_num = (EditText) findViewById(sell_order_num);
        ...
        add_sell_order_detail = (TextView) findViewById(R.id.add_sell_order_detail);
        add_sell_order_detail.setOnClickListener(this);
        sell_save.setOnClickListener(this);
...
//            return;
//        }
        sell_save.requestFocusFromTouch();
        for (int i = 0; i < sellDetails.size(); i++) {
